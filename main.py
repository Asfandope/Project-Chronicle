...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("project_chronicle.log"), logging.StreamHandler()],
)
    ...
    try:
        ...
        with get_db_session() as session:
            try:
                ...
                logger.warning(
                    f"Parameter initialization failed (continuing anyway): {e}"
                )
...
def create_app() -> FastAPI:
    ...
    async def health_check():
        ...
        try:
            ...
            return {"status": "healthy", "services": services, "database": "connected"}
        except Exception as e:
    ...
    async def system_status():
        ...
        try:
            ...
            return JSONResponse(
                status_code=500, content={"error": f"Status check failed: {str(e)}"}
            )
