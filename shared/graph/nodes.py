...
class TextBlockNode(BaseNode):
    ...
    @classmethod
    def from_text_block(
        cls, text_block: TextBlock, node_id: Optional[str] = None
    ) -> "TextBlockNode":
...
class ImageNode(BaseNode):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ImageNode(id={self.node_id[:8]}, size={size_str}, page={self.page_num})"
        )
...
class PageBreakNode(BaseNode):
    ...
    def set_page_dimensions(self, page_width: float, page_height: float):
        ...
        self.bbox = BoundingBox(x0=0, y0=page_height, x1=page_width, y1=page_height)
