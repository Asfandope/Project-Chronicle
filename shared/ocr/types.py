...
class OCRError(Exception):
    ...
    def __init__(
        self, message: str, page_num: Optional[int] = None, brand: Optional[str] = None
    ):
...
class TextBlock:
    ...
    def total_characters(self) -> int:
        return sum(word.char_count for line in self.lines for word in line.words)
...
class PageOCRResult:
    ...
    def total_confidence(self) -> float:
        ...
        weighted_sum = sum(
            block.confidence * block.total_characters for block in self.text_blocks
        )
...
class OCRResult:
    ...
    def total_text(self) -> str:
        ...
        return "\n\n".join(
            f"=== Page {page.page_num} ===\n{page.full_text}" for page in self.pages
        )
    ...
    def average_confidence(self) -> float:
        ...
        weighted_sum = sum(
            page.total_confidence * page.character_count for page in self.pages
        )
        return weighted_sum / total_chars
...
class PreprocessingConfig:
    ...
    quality_metrics: List[str] = field(
        default_factory=lambda: ["sharpness", "contrast", "noise_level"]
    )
