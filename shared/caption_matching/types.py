...
class MatchingError(Exception):
    ...
    def __init__(
        ...
        caption_node_id: Optional[str] = None,
    ):
...
class MatchConfidence:
    ...
    def is_high_confidence(self) -> bool:
        ...
        return (
            ...
            and self.ambiguity_level <= 0.3
            and self.competing_matches <= 1
        )
...
class SpatialMatch:
    ...
    def is_valid_match(self) -> bool:
        ...
        return (
            self.match_confidence.overall_confidence >= 0.8
            and self.proximity_score.overall_score >= 0.7
        )
...
class MatchingResult:
    ...
    def average_confidence(self) -> float:
        ...
        if not self.successful_pairs:
            return 0.0
        return sum(pair.pairing_confidence for pair in self.successful_pairs) / len(
...
class MatchingMetrics:
    ...
    def calculate_performance_scores(self) -> None:
        ...
        if self.correct_matches + self.incorrect_matches > 0:
            self.precision = self.correct_matches / (
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "matching_performance": {
                ...
                "success_rate": self.successful_matches
                / max(1, self.total_matches_attempted),
            },
            "accuracy_metrics": {
