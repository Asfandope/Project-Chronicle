...
from .types import FormattingError, FormattingOptions, OutputFormat, XMLConfig
...
class XMLFormatter:
    ...
    def __init__(
        ...
        self.logger.info(
            "XML formatter initialized", output_format=self.config.output_format.value
        )
    ...
    def _sort_attributes_dict(self, attrs: Dict[str, str]) -> Dict[str, str]:
        ...
        priority_map = {
            attr: i for i, attr in enumerate(self.options.attribute_sort_order)
        }
