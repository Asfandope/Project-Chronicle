...
# BoundingBox moved to shared/types/common.py to avoid circular imports
...
class PageLayout:
    ...
    def get_main_content_blocks(self) -> List[TextBlock]:
        ...
        return [
            block for block in self.text_blocks if block.block_type in content_types
        ]
    ...
    def matches(self, block: TextBlock, page_layout: PageLayout) -> Tuple[bool, float]:
        ...
        try:
            ...
            if "font_size_min" in self.conditions:
                if (
                    not block.font_size
                    or block.font_size < self.conditions["font_size_min"]
                ):
                    return False, 0.0
            ...
            if "font_size_max" in self.conditions:
                if (
                    not block.font_size
                    or block.font_size > self.conditions["font_size_max"]
                ):
                    return False, 0.0
            ...
            if "position_bottom_threshold" in self.conditions:
                if block.bbox.y1 < (
                    ...
                    - self.conditions["position_bottom_threshold"]
                ):
                    return False, 0.0
    ...
    def get_default_rules(cls) -> List[ClassificationRule]:
        ...
        return [
            ...
            ClassificationRule(
                ...
                conditions={"position_top_threshold": 50, "max_words": 15},
                priority=9,
                confidence=0.8,
            ),
            # Footer rules
            ClassificationRule(
                ...
                conditions={"position_bottom_threshold": 50, "max_words": 15},
                priority=9,
                confidence=0.8,
            ),
            # Page number rules
            ...
            ClassificationRule(
                ...
                conditions={"font_size_max": 10, "max_words": 50},
                priority=6,
                confidence=0.7,
            ),
            # Heading rules
            ClassificationRule(
                ...
                conditions={"font_size_min": 14, "max_words": 15},
                priority=5,
                confidence=0.7,
            ),
...
class VisualizationConfig:
    ...
    colors: Dict[BlockType, str] = field(
