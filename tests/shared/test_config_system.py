...
class TestXMLSchemaCompliance:
    ...
    def test_article_structure_matches_xsd(self):
        ...
        article_data = {
            ...
            "page_start": 1,
            "page_end": 2,
            "title": {"content": "Test Article Title", "confidence": 0.95},
            "body": {
                "content": [
                    {"content": "First paragraph of the article.", "confidence": 0.92}
                ]
            },
            "provenance": {
...
class TestConfigurationManager:
    ...
    def test_feature_flag_system(self):
        ...
        if "uk_spelling_preference" in custom_settings:
            uk_spelling = config_manager.is_feature_enabled(
                brand, "uk_spelling_preference"
            )
