...
async def analyze_layout(
    request_data: LayoutAnalysisRequest, request: Request
    ...
    try:
        ...
        logger.error("Layout analysis failed", job_id=request_data.job_id, error=str(e))
...
async def classify_blocks(
    blocks_data: Dict[str, Any], request: Request
) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Block classification failed: {str(e)}"
        )
