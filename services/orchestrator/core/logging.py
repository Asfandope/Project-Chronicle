...
def log_job_event(
    logger: FilteringBoundLogger, event: str, job_id: str, **kwargs
) -> None:
    """Log a job-related event with consistent formatting."""
    logger.info(event, job_id=job_id, event_type="job", **kwargs)


def log_processing_stage(
    logger: FilteringBoundLogger, stage: str, job_id: str, status: str, **kwargs
) -> None:
...
def log_error_with_context(
    logger: FilteringBoundLogger, error: Exception, context: Dict[str, Any]
) -> None:
